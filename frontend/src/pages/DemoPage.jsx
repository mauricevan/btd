  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-12 font-sans">
      ...
      >
        ...
        <h1 className="text-2xl font-bold mb-2 text-domred">{t("demo_for", { name: product.name })}</h1>
        <p className="text-gray-700 mb-6 text-base md:text-lg font-medium">{t("demo_sample", { name: product.name })}</p>
